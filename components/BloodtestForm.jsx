...
import { COLOR_PRIMARY_2 } from '../styles/base';

const validationSchema = yup.object({
  testName: yup.string().required('This field is required'),
  testResult: yup.number().typeError('This field must be a number').required('This field is required'),
});

export function BloodtestForm({ values, resetValues, onSubmit, resetAnswer, getNameSuggestions }) {
      ...
      {props => (
        <>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            ...
            <Pressable style={[styles.submitButton, styles.resetButton]} onPress={() => handleReset(props)}>
